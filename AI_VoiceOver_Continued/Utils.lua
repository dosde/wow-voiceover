...
function Utils:IsSoundEnabled()
    ...
    if channel == "Master" then
        -- Master intentionally bypasses the individual SFX/Dialog/Music
        -- toggles. The inherited player incorrectly required SFX even here.
        return true
    end
    ...
    return (tonumber(GetCVar(format("Sound_%sVolume", channel))) or 1) > 0
end
