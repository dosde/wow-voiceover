...
function QuestOverlayUI:CreatePlayButton(questID)
    ...
    playButton:SetNormalTexture([[Interface\AddOns\AI_VoiceOver_Continued\Textures\QuestLogPlayButton]])
    playButton:SetDisabledTexture([[Interface\AddOns\AI_VoiceOver_Continued\Textures\QuestLogPlayButton]])
...
function QuestOverlayUI:UpdatePlayButtonTexture(questID)
    ...
    if button then
        ...
        local texturePath = isPlaying and [[Interface\AddOns\AI_VoiceOver_Continued\Textures\QuestLogStopButton]] or [[Interface\AddOns\AI_VoiceOver_Continued\Textures\QuestLogPlayButton]]
